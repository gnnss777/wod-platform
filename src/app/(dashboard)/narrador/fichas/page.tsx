              ...
              {characters.map((c) => (
                <tr key={c.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-900">
                  <td className="px-4 py-2">
                    <Link href={`/jogador/fichas/${c.id}`} className="font-medium hover:underline">
                      {c.name}
                    </Link>
                  </td>
                  ...
                  <td className={`px-4 py-2 text-xs font-medium ${statusColor[c.status] || "text-zinc-500"}`}>
                  ...
                  <td className="px-4 py-2 text-center">
                    <ApproveActions characterId={c.id} status={c.status} />
                  </td>
                </tr>
              ))}
            </tbody>
